...
Buka apps temanbumil real device
  Open Application    ${REMOTE_URL}    platformName=${PLATFORM_NAME}    platformVersion=${PLATFORM_VERSION_REAL_7}    deviceName=${DEVICE_NAME_REAL_7}    app=${APP}    appPackage=${APP_PACKAGE}
