...
Question Program Hamil
  ...
  Click Element    //android.widget.TextView[contains(@resource-id,'com.temanbumil.android:id/btn_negative')]
  #cek masuk ke halaman question
  Wait Until Element Is Visible    //android.widget.TextView[contains(@resource-id,'com.temanbumil.android:id/tv_q_main')]    100s
  Element Text Should Be    //android.widget.TextView[contains(@resource-id,'com.temanbumil.android:id/tv_q_main')]    Silakan pilih fitur yang Mums inginkan
  #pilih Program Hamil
  Click Element    //android.widget.Button[contains(@resource-id,'com.temanbumil.android:id/btn_q_main_vertillity')]
  Wait Until Element Is Visible    //android.widget.TextView[contains(@resource-id,'com.temanbumil.android:id/tvDescription')]    100s
  Element Text Should Be    //android.widget.TextView[contains(@resource-id,'com.temanbumil.android:id/tvDescription')]    Apakah Mums yakin ingin menggunakan fitur Program Hamil?
  #Pilih No
  # Click Element    //android.widget.TextView[contains(@resource-id,'com.temanbumil.android:id/txt_negative')]
  # Wait Until Element Is Visible    //android.widget.Button[contains(@resource-id,'com.temanbumil.android:id/btn_q_main_vertillity')]    100s
  #tanya lagi
  # Sleep    2s
  # Click Element    //android.widget.Button[contains(@resource-id,'com.temanbumil.android:id/btn_q_main_vertillity')]
  # Wait Until Element Is Visible    //android.widget.TextView[contains(@resource-id,'com.temanbumil.android:id/tvDescription')]    100s
  ...
  #masuk ke halaman program hamil sebelum muncul Coachmark
  Wait Until Page Contains Element    //android.widget.ImageView[contains(@resource-id,'com.temanbumil.android:id/btn_actionbar_notification')]   100s   #icon lonceng
...
Question Tumbuh Kembang Positive
  ...
  Tap    ${APP}:id/et_newborn_datalingkarkepala
...
Question Tumbuh Kembang Negative Tanggal
  ...
  # Sleep    2s
  #klik pilih
  Wait Until Element Is Visible    ${APP}:id/btn_q_date_choose    100s
  Click Element    ${APP}:id/btn_q_date_choose
...
cek & hapus data awal
  ${dataanak}   Run Keyword And Return Status    Wait Until Page Contains Element    xpath=//android.widget.Button[@text='GOT IT']
  Run Keyword If    ${dataanak}    Coachmark Got It
  Run Keyword If    ${dataanak}    Hapus Data Semua Program
