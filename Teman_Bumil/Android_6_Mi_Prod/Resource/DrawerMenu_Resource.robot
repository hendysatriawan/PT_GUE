...
Program Hamil Menu Artikel
  ...
  Wait Until Element Is Visible    //com.android.internal.widget.ViewPager[contains(@resource-id,'android:id/resolver_page')]
  Sleep    2s
  Press Keycode    ${back}
  Wait Until Page Does Not Contain Element    //com.android.internal.widget.ViewPager[contains(@resource-id,'android:id/resolver_page')]
  Sleep    2s
...
Program Hamil Menu Tips
  ...
  #Share
  Click Element    //android.widget.ImageButton[contains(@resource-id,'com.temanbumil.android:id/btn_actionbar_share')]
  Wait Until Page Contains Element    //com.android.internal.widget.ViewPager[contains(@resource-id,'android:id/resolver_page')]    100s
  Press Keycode    ${back}
  Sleep    2s
  Page Should Not Contain Element    //com.android.internal.widget.ViewPager[contains(@resource-id,'android:id/resolver_page')]   100s
  #keluar dari tips
